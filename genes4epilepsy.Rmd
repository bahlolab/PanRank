...
sorted by decreasing PanRank Dominant score, and only "Novel" (not 
yet associated with selected phenotype) genes are shown. Hover over gene names 
for more information and external links.
  </div>
