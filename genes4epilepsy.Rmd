---
title: 'PanRank - PanelApp Australia <img src="img/WEHI.png" align="right" height="80"/>'
---
...
This page contains **PanRank** candidate gene rankings based on gene panels from [Genes4Epilepsy](https://bahlolab.github.io/Genes4Epilepsy/). PanRank scores are between 0 and 1 and represent the predicted probability that a gene is disease-causing with the specified mode of inheritance. The "Inheritance" column indicates the known mode of inheritance used to train the model.
